...
class TestQuestionAPI:
    ...
    async def test_get_question(self, api_client: AsyncClient, db_session: AsyncSession):
    ...
    async def test_list_questions(self, api_client: AsyncClient, db_session: AsyncSession):
        user = await create_test_user(db_session)
    ...
    async def test_update_question_not_owner(
        ...
        question = await create_test_question(db_session, user1.id)
        await db_session.commit()
